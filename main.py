...
def results(hb, st, initial_balance):
    print(f"\nBuy and Hold Final Balance: ${hb:.2f}")
    print(f"Strategy Final Balance: ${st:.2f}\n")
    print(f"Buy and Hold Total Return: {((hb - initial_balance) / initial_balance) * 100:.2f}%")
    print(f"Strategy Total Return: {((st - initial_balance) / initial_balance) * 100:.2f}%\n")
